...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: '인문학 강좌는 센터  안내데스크에서 직접 오프라인으로만 신청 가능합니다. 운영시간은 평일 오전 9시부터 오후 6시까지이며, 선착순 접수입니다. 수강료는 신청 시 현장에서 납부해 주시기 바랍니다.',
    popular: true
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer: '공연 티켓은 센터  매표소에서 직접 구매하셔야 합니다. 현장 구매만 가능하며, 온라인 예매는 지원하지 않습니다. 매표소 운영시간은 평일 오전 9시부터 오후 6시까지입니다.',
    popular: true
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: '공연장 대관은 이용 희망일 최소 30일 전에 신청해 주시기 바랍니다. 대관 신청은 센터  안내데스크에 직접 방문하여 신청서를 작성하고 제출하셔야 합니다. 검토 후 승인 여부를 알려드리며, 대관료는 승인 후 7일 이내 납부해 주셔야 합니다.'
  },
  {
    id: 7,
    category: '시설이용',
  ...
  },
  {
    ...
    answer: '분실물은 접수일로부터 3개월간 보관됩니다. 분실물 확인은 센터  안내데스크에 직접 방문하여 확인하실 수 있습니다. 귀중품의 경우 보관 즉시 안내드리도록 하겠습니다.'
  },
  {
    id: 11,
    category: '시설이용',
